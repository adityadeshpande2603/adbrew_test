...
This submission is my response to the Adbrew technical test, which is designed to evaluate Python, Django, React, and general web development skills. The task intentionally uses an unconventional and slightly contrived setup to assess problem-solving ability, adaptability, and the ability to quickly learn and apply new concepts—particularly basic Docker fundamentals—during development.
...
* Mongo: This is a DB instance running on port 27017. Django views already had code written to connect to this instance of Mongo.
